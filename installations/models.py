...
class Installation (models.Model):
    ...
    BRAND_CHOICE =(('S', 'Select Brand'),('S', '---------------- Battery Brands----------------'), ('AMARON', 'AMARON'), ('ARCCHAR', 'ARCCHAR'), ('DAYSTAR', 'DAYSTAR'), ('E.P', 'E.P'), ('EVER EXCEED', 'EVER EXCEED'), ('FELICITY', 'FELICITY'), ('G.P', 'G.P'), ('GASTON', 'GASTON'),
                    ...
                    ('TRATA', 'TRATA'), ('TROJAN SAGEM', 'TROJAN SAGEM'), ('TROJAN(SLIM)', 'TROJAN(SLIM)'), ('S', '---------------- Generator Brands ----------------'), ('C-POWER', 'C-POWER'), ('CUMMINS', 'CUMMINS'), ('FG WILSON', 'FG WILSON'), ('GHADDOR', 'GHADDOR'), ('HAT GLOBAL SP', 'HAT GLOBAL SP'),
                    ...
                    ('MIKANO', 'MIKANO'), ('PERKINS', 'PERKINS'), ('S', '---------------- Inverter Brands ----------------'), ('AARCHOR', 'AARCHOR'),('BPC', 'BPC'),('COMP HC', 'COMP HC'),('EMERSON', 'EMERSON'),('ENDLESS POWER', 'ENDLESS POWER'),('ENERGIER', 'ENERGIER'),
